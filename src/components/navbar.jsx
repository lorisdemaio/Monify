...
export default function Navbar() {
  ...
  useEffect(() => {
    scrollTo(0, 0);
    if(location.pathname === '/' || location.pathname === "/register") setNav(false);
    else setNav(true);
  }, [location]);
          ...
          <>
            <div className='flex flex-row  items-center gap-4'>
              ...
              <span className='text-xl uppercase font-semibold'>
                {
                  location.pathname.startsWith("/infogoal/") ? 
                  `OBIETTIVI DI ${nome}` : 
        ...
        <div className='flex justify-center items-center gap-4'>
            {
              /*
                <Link>
                  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-bell opacity-[0.5]" viewBox="0 0 16 16">
             ...
             <Link to="/goals">
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-trophy" viewBox="0 0 16 16">
